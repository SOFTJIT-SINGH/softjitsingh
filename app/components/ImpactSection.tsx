      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-light text-gray-400 max-w-2xl">
            Production software serving real businesses across {domains.length} industries.
          </p>
        </motion.header>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {domains.map((domain, idx) => (
            <motion.li
              ...
              className="group bg-white/[0.02] border border-white/5 hover:border-blue-500/20 rounded-xl p-5 transition-all duration-300"
            >
        ...
        <motion.p
          ...
          className="mt-10 text-center text-xs text-gray-600 font-mono tracking-wider"
        >
          {SITE.metrics.productionApps}+ production applications shipped across {domains.length} industries
        </motion.p>
      </div>
    </section>
  );
