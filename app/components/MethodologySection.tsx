      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8">
        <div className="mb-16">
          ...
          <p className="text-xl md:text-2xl font-light text-gray-400 max-w-2xl">
            Production-grade by default. Every project ships with the same discipline.
          </p>
        </div>
        ...
        <ol className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {steps.map((step, idx) => (
            <motion.li
              ...
              className="group bg-zinc-900/30 border border-white/5 hover:border-blue-500/30 rounded-2xl p-8 transition-all"
            >
              <div className="flex items-start gap-6">
                <div className="text-3xl font-bold text-white/10 group-hover:text-white/20 transition-colors" aria-hidden="true">
                  {step.number}
                </div>
                <div>
