  ...
  return (
    <footer className="w-full bg-zinc-950 py-16 border-t border-white/10 text-center">
      ...
      <div className="flex justify-center gap-8 mb-8">
        <a href="mailto:soft@gmail.com" className="p-4 rounded-full bg-zinc-900 text-gray-400 hover:text-white hover:bg-zinc-800 transition-all"><FaEnvelope size={24} /></a>
